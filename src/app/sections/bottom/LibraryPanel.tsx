...
export function LibraryPanel({
  ...
  return (
    <article className="libraryWorkspacePanel" aria-label="Library workspace">
      <section className="libraryColumn" aria-label="Tunings">
        <div className="libraryColumnHeader">
          <p className="bottomModuleLabel">Tunings</p>
        </div>
        <div className="libraryColumnControls">
      ...
      <section className="libraryColumn" aria-label="Scales">
        <div className="libraryColumnHeader">
          <p className="bottomModuleLabel">Scales</p>
        </div>
        <div className="libraryList" role="list">
      ...
      <section className="libraryColumn" aria-label="Measures">
        <div className="libraryColumnHeader">
          <p className="bottomModuleLabel">Measures</p>
        </div>
        <div className="libraryColumnControls">
          <div className="referenceCommandSearchField">
            <input
      ...
      <section className="libraryColumn" aria-label="Chords">
        <div className="libraryColumnHeader">
          <p className="bottomModuleLabel">Chords</p>
        </div>
        <div className="libraryList" role="list">
